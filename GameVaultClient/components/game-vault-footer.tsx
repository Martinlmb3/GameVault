    ...
    <footer className="bg-slate-800 border-t border-slate-700 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/games" className="text-slate-400 hover:text-blue-400 text-sm transition-colors">
                  My Games
                </Link>
              </li>
              <li>
                <Link href="/wishlist" className="text-slate-400 hover:text-blue-400 text-sm transition-colors">
                  Wishlist
                </Link>
              </li>
              <li>
                <Link href="/reviews" className="text-slate-400 hover:text-blue-400 text-sm transition-colors">
                  Reviews
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/help" className="text-slate-400 hover:text-blue-400 text-sm transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-slate-400 hover:text-blue-400 text-sm transition-colors">
                  Contact Us
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-slate-700 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-slate-400 text-sm">© {new Date().getFullYear()} Game Vault. All rights reserved.</p>
          <p className="text-slate-400 text-sm mt-2 sm:mt-0">Made with ❤️ for gamers</p>
        </div>
      </div>
    </footer>
  )
